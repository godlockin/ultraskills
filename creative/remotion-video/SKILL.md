...
description: 使用 React 和 Remotion 框架创建程序化视频，支持动画、特效和自动化视频生成
version: 1.0.0
tags: [video, react, remotion, animation, creative, automation]
---

# Remotion Video Creator - React 程序化视频制作
...
### 在 Remotion Studio 中渲染

1. 运行 `npm run dev` 打开 Studio
2. 点击 "Render" 按钮
3. 选择格式和质量
4. 等待渲染完成
